...
# or using extend_pandas() :)
    ...
    stock.plot_log_returns(savefig='log_returns.png')
    stock.plot_monthly_heatmap(savefig='monthly_heatmap.png')
    stock.plot_returns(savefig='returns.png')
    stock.plot_rolling_beta(savefig='rolling_beta.png', benchmark='SPY')
    stock.plot_rolling_sharpe(savefig='olling_sharpe.png')
    stock.plot_rolling_sortino(savefig='rolling_sortino.png')
    stock.plot_rolling_volatility(savefig='rolling_volatility.png')
    stock.plot_snapshot(savefig='snapshot.png')
    stock.plot_yearly_returns(savefig='yearly_returns.png')
